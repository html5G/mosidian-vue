    ...
    methods: {
      ...
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.userId) {
            this.$http({
              url: this.$http.adornUrl(`/logistics/info/${this.dataForm.userId}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.userId = data.logistics.userId
                this.dataForm.enId = data.logistics.enId
                this.dataForm.name = data.logistics.name
                this.dataForm.username = data.logistics.username
                this.dataForm.website = data.logistics.website
                this.dataForm.scale = data.logistics.scale
                this.dataForm.audit = data.logistics.audit
                this.dataForm.synopsis = data.logistics.synopsis
                this.dataForm.corporation = data.logistics.corporation
                this.dataForm.reason = data.logistics.reason
                this.dataForm.eserver = data.logistics.eserver
                this.dataForm.companies = data.logistics.companies
                this.dataForm.headName = data.logistics.headName
                this.dataForm.sector = data.logistics.sector
                this.dataForm.eposition = data.logistics.eposition
                this.dataForm.headCard = data.logistics.headCard
                this.dataForm.emobile = data.logistics.emobile
                this.dataForm.eemail = data.logistics.eemail
                this.dataForm.modifier = data.logistics.modifier
                this.dataForm.credits = data.logistics.credits
                this.dataForm.enlicenseId = data.logistics.enlicenseId
                this.dataForm.avatar = data.logistics.avatar
                this.dataForm.domicile = data.logistics.domicile
                this.dataForm.enlicense = data.logistics.enlicense
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/logistics/${!this.dataForm.userId ? 'save' : 'update'}`),
              method: 'post',
